...
(function( factory ){
    ...
    if( typeof define === 'function' && define.amd ){
        ...
        define( [
            'jquery', 'load-image', 'load-image-meta', 'load-image-exif', 'load-image-ios', 'canvas-to-blob', './jquery.fileupload-process'
        ], factory );
    }else{
        // Browser globals:
        ...
        processActions: {
            ...
            saveImageMetaData: function( data, options ){
                ...
                var file = data.files[data.index], blob = new Blob( [
                    data.imageHead, // Resized images always have a head size of 20 bytes,
